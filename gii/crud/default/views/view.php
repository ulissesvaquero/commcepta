...
<?= "            <?= Html::a(" . $generator->generateString('Salvar como novo') . ", ['save-as-new', " . $generator->generateUrlParams() . "], ['class' => 'btn btn-info']) ?>" ?>
<?php endif;?>
            <?= "
            <?= Html::a(" . $generator->generateString('Atualizar') . ", ['update', " . $generator->generateUrlParams() . "], ['class' => 'btn btn-primary']) ?>
            <?= Html::a(" . $generator->generateString('Excluir') . ", ['delete', " . $generator->generateUrlParams() . "], [
                'class' => 'btn btn-danger',
                'data' => [
                    'confirm' => " . $generator->generateString('Deseja realmente remover este item?') . ",
                    'method' => 'post',
                ],
            ])
            ?>\n" ?>
